    ...
    return (
      <div>
        <UpModal 
          ...
          setIsOpen={setKeyboardShortcutsOpen}
          wide={true}
        >
          <div className="opacity-50">
            <p className="font-bold mb-8">The Prioritizer has a goal to enable you to go through your entire workflow process of creating tasks, buckets, and stages without your hands leaving your keyboard.</p>
        ...
        <footer className="pb-8">
          <button className="link" onClick={() => setKeyboardShortcutsOpen(true)}>Keyboard shortcuts</button>
